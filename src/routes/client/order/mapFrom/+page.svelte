<script>
		...
		maps.events.add('click', function (e) {
			...
			// Если нет – создаем.
				...
				myPlacemark.events.add('dragend', function () {
					mapsGetAddress(myPlacemark.geometry.getCoordinates());
				});
			}
			mapsGetAddress(coords);
		});
	}

	function mapsCreatePlacemark(coords) {
	...
	function mapsGetAddress(coords) {
