...
const Page = (0, import_chunks.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `${`<div class="${"position-fixed mt-3 text-center w-100"}" style="${"left:0"}"><button class="${"btn btn-sm btn-light"}">\u0412\u0445\u043E\u0434 \u0434\u043B\u044F \u043A\u043B\u0438\u0435\u043D\u0442\u043E\u0432</button></div>
	<div class="${"d-flex justify-content-center align-items-center"}" style="${"min-height: 100vh"}"><div class="${"bg-light p-3 rounded text-center"}" style="${"min-width: 470px;"}"><h4 class="${"mb-3"}">\u0412\u0445\u043E\u0434 \u0434\u043B\u044F \u0432\u043E\u0434\u0438\u0442\u0435\u043B\u0435\u0439</h4>
