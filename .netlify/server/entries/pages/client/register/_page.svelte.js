...
const Page = (0, import_chunks.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `${`<div class="${"position-fixed mt-3 text-center w-100"}" style="${"left:0"}"><button class="${"btn btn-sm btn-light"}">\u0420\u0435\u0433\u0438\u0441\u0442\u0440\u0430\u0446\u0438\u044F \u0432\u043E\u0434\u0438\u0442\u0435\u043B\u0435\u0439</button>
		<div class="${"d-flex justify-content-center align-items-center"}" style="${"min-height: 100vh"}"><div class="${"bg-light p-3 rounded text-center"}" style="${"min-width: 470px;"}"><h4 class="${"mb-3"}">\u0417\u0430\u0440\u0435\u0433\u0438\u0441\u0442\u0440\u0438\u0440\u043E\u0432\u0430\u0442\u044C\u0441\u044F</h4>
				<input class="${"form-control mb-3"}" placeholder="${"\u0432\u0430\u0448\u0435 \u0438\u043C\u044F"}"${(0, import_chunks.d)("value", client.value.name, 0)}>
